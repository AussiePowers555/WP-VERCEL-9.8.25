      ...
      <div className="bg-muted/30 rounded-lg p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
          ...
          <div>
            ...
            <div className="mt-1 space-y-1">
              <p>Date: {typeof caseData.accidentDate === 'string' ? caseData.accidentDate : (caseData.accidentDate ? new Date(caseData.accidentDate).toLocaleDateString() : 'Not provided')}</p>
