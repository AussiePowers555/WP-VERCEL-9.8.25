...
export const DynamicComponents = {
  ...
  Chart: createDynamicComponent(
    () => import('@/components/ui/chart').then(m => ({ default: (m as any).default })),
  ...
  PDFViewer: createDynamicComponent(
    () => import('@/app/(app)/cases/[caseId]/pdf-viewer').then(m => ({ default: (m as any).default })),
    <div className="bg-gray-100 rounded-lg p-8 animate-pulse">
  ...
  ImageGallery: createDynamicComponent(
    () => import('@/app/(app)/cases/[caseId]/image-gallery').then(m => ({ default: (m as any).default })),
  ...
  SignaturePad: createDynamicComponent(
    () => import('@/components/SignaturePad').then(m => ({ default: (m as any).default })),
