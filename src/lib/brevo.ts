...
/**
 * Generate welcome email for new workspace users
 */
export function generateWelcomeEmail(
  ...
  return `
    ...
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Welcome to White Pointer Recoveries</title>
      <style>
        body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; }
        .container { max-width: 600px; margin: 0 auto; padding: 20px; }
        .header { background-color: #1e40af; color: white; padding: 20px; text-align: center; }
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>Welcome to White Pointer Recoveries</h1>
        </div>
        
        <div class="content">
          <p>Dear ${contactName},</p>
          
          <p>Your workspace account has been created successfully. You now have access to the White Pointer Recoveries system for <strong>${workspaceName}</strong>.</p>
          ...
          <div class="warning">
            <strong>Important:</strong> You will be required to change your password on first login. Please keep your new password secure.
          </div>
          
          <div style="text-align: center;">
            <a href="${loginUrl}" class="button">Login to Your Workspace</a>
          </div>
          
          <h3>What you can do in your workspace:</h3>
          <ul>
            <li>View and manage cases assigned to your organization</li>
            <li>Track case progress and updates</li>
            <li>Access documents and forms</li>
            <li>Communicate with the White Pointer team</li>
          </ul>
          
          <p>If you have any questions or need assistance logging in, please don't hesitate to contact our support team.</p>
        ...
        <div class="footer">
          <p>This email contains confidential login information. Please do not forward.</p>
          <p>White Pointer Recoveries Pty Ltd</p>
        </div>
      </div>
    </body>
...
/**
 * Send welcome email to new workspace user
 */
export async function sendWelcomeEmail(args: {
  ...
  const loginUrl = process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:9015';
  ...
  return sendEmail({
    to: args.to,
    subject: `Welcome to White Pointer Recoveries - ${args.workspaceName}`,
    htmlContent,
    senderName: 'White Pointer Recoveries'
  });
}
