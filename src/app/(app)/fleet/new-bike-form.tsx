                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>🚴‍♂️ Bike Photo (Drag & Drop + JPEG Optimized)</FormLabel>
                                    <FormControl>
                                        <ImageUpload
                                            value={field.value}
                                            onChange={(url) => {
                                            ...
                                            onRemove={() => {
                                                field.onChange("https://placehold.co/300x200.png");
                                                setImagePreview("https://placehold.co/300x200.png");
                                            }}
                                            disabled={isLoading}
                                            placeholder="Drop a bike photo here or click to browse"
                                            className="w-full"
                                        />
                                    </FormControl>
                                    <FormMessage />
